...
2. 20180109、20180110、20180111版本，有四台机器大部分测试未通过

- pc1
   - 20180109版本，不通过的测试用例有50个
   - 20180110版本，不通过的测试用例有50个
   - 20180111版本，不通过的测试用例有50个
...
用例|0108-1|0108-2|0108-3|0109|0110|0111|
-----|-----|-----|-----|-----|-----|-----|
YY|0|1|0|1|1|1|
3DMark|0|0|0|1|1|1|
应用商店|未测试|0|未测试|0|0|0|
电子邮件|0|0|0|0|0|0|
MS Excel|1|1|1|0|0|0|
图片管理器|1|1|1|1|0|1|
launcher|0|0|0|0|0|0|
Sparkle|1|0|1|1|1|1|
system_ui|0|0|0|0|0|0|
携程|0|1|1|1|0|0|

- qemu1
   - 0108-1版本，不通过测试用例有53个
   - 0108-2版本，不通过测试用例有55个
   - 0108-3版本，不通过测试用例有54个
   - 0109版本，不通过测试用例有50个
   - 0110版本，不通过测试用例有51个
   - 0111版本，不通过测试用例有51个

- laptop1-T43U
   - 0108-1版本，不通过测试用例有46个
   - 0108-2版本，不通过测试用例有47个
   - 0108-3版本，不通过测试用例有45个
   - 0109版本，不通过测试用例有50个
   - 0110版本，不通过测试用例有21个
   - 0111版本，不通过测试用例有51个

- laptop2-T45
   - 0108-1版本，不通过测试用例有45个
   - 0108-2版本，不通过测试用例有47个
   - 0108-3版本，不通过测试用例有45个
   - 0109版本，不通过测试用例有49个
   - 0110版本，不通过测试用例有50个
