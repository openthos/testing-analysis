 ...
 * @since API Level 16
 */
public class RUiScrollable extends RUiCollection {
     ...
     * @since API Level 16
     */
    public RUiScrollable(UiSelector container) {
     ...
     * @since API Level 16
     */
    public RUiScrollable setAsVerticalList() {
        Tracer.trace();
     ...
     * @since API Level 16
     */
    public RUiScrollable setAsHorizontalList() {
        Tracer.trace();
    ...
    public RUiObject getRChildByInstance(UiSelector childPattern, int instance)
            throws UiObjectNotFoundException {
        ...
        return new RUiObject(patternSelector);
    }
     ...
     * @since API Level 16
     */
    public RUiScrollable setMaxSearchSwipes(int swipes) {
        Tracer.trace(swipes);
     ...
     * @since API Level 16
     */
    public RUiScrollable setSwipeDeadZonePercentage(double swipeDeadZonePercentage) {
